...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="">
                <form class="row g-3" action="index.php?act=add_product" enctype="multipart/form-data" method="post">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <button  class="btn btn-primary" class="mt-2" type="submit" name="addNew">Add new</button>
                    </div>
                </form>
